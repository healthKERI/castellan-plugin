# -*- encoding: utf-8 -*-
"""Dialog for deleting a received credential from the Castellan server."""
...
class DeleteReceivedCredentialDialog(LocksmithResourceDeletionDialog):
    """Dialog for confirming and deleting a received credential from the Castellan server."""
    ...
    def __init__(
        ...
        """Initialize the delete received credential dialog.
    ...
    async def _do_delete(self):
        ...
        Removes the received credential from the Castellan server.
        """
        ...
        try:
            result = await remoting.delete_received_credential(self.app, self.credential_said)
            ...
            logger.info(f"Received credential {self.credential_said} deleted from Castellan server")
            ...
            logger.exception(f"DeleteReceivedCredentialDialog: deletion failed: {exc}")
